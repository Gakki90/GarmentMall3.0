...
Page({
  ...
  //   var url = 'url';
  //   console.log(options.orderdata+"dada")
  //   var arrayOrder = JSON.parse(options.orderdata)//传值
  //   console.log(arrayOrder + "dada")
  //   if (options.orderdata==null){
  //    wx.showToast({
  //      title:'数据为空',
  //    })
  //   return;
  ...
  //        orderdata: arrayOrder,
  //       // order_num: orderdata[0]["orderId"],
  //       })
  //       console.log('statusorder'+this.data.status)
  //       console.log('dataorder' + this.data.orderdata[0]["orderId"])
